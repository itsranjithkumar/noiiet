...
const WhatsAppButton: React.FC = () => {
  const phoneNumber = '918489545036'; // Formatted without + for WhatsApp link
  ...
  return (
    <div 
      className="fixed right-4 bottom-4 z-50 cursor-pointer hover:scale-110 transition-transform duration-300"
